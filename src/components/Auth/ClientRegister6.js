      ...
      <form className="App-form App-form-register">
        <div className="container">
          ...
          <div className="row justify-content-center mt-2">
            <div className="col-12 col-sm-6 text-center">
              <div className="text-white text-decoration-none App-Question-h6 text-fucsia">
            ...
            <div className="col-12 col-sm-4 text-centerr">
              <div className="custom-control custom-checkbox">
                ...
                <label className="custom-control-label" htmlFor="defaultUnchecked">
                  <span className="App-Question-h6 text-white terminos">Declaro que soy mayor de edad y acepto los
