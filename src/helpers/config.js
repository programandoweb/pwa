export default{
  ...
  ConfigApirest   : (document.location.hostname==='localhost')?'http://localhost/erosapp/backend/ApiRest/':(process.env.NODE_ENV==='development')?'https://api.eroscort.com/ApiRest/':'https://api.eroscort.com/ApiRest/',
}
